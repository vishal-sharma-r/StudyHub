exports.passwordUpdated = (email, name) => {
    ...
    <body>
        <div class="container">
            <a href="github.com"><img class="logo"
                    src="https://res.cloudinary.com/dvnvedyrb/image/upload/v1694806883/StudyHub/StudyHub_LO_ogo_bxl8ts.png" alt="StudyHub Logo"></a>
